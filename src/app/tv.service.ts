...
//* https://api.themoviedb.org/3/tv/top_rated
  getAllTvs(currentPage:number=1,language:string='en-US'):Observable<any>{
    return this.http.get(`https://api.themoviedb.org/3/tv/top_rated?api_key=${this.api}&language=${language}&page=${currentPage}`)
  }
  //*https://api.themoviedb.org/3/tv/{series_id}
  getTvbyId(tvId: number,language:string) :Observable<any>{
    return this.http.get(`https://api.themoviedb.org/3/tv/${tvId}?api_key=${this.api}&language=${language}`)
  }
